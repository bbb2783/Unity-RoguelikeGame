...
========================================================<br>
<<<<<<< HEAD
3월 25일 (아이템 줍기 space키, 플레이어 이동, 카메라 플레이어 따라 이동, i키를 열어 도감 확인)
=======
<h3>수집맵 히스토리</h3>
...
4월 07일 - 식물도감에 있는 식물에 마우스포인트를 올릴시 tooltip 
>>>>>>> 2ef3785b0013d403ce3b1e46cae410048e06a61f

<br>
<h3>몬스터맵 히스토리</h3>
4월 02일 - 몬스터가 플레이어를 따라가도록 설정, 몬스터 자동 스폰
4월 13일 - 몬스터 소환레벨 설정, main 화면 샘플 제작(임시, 프로토타입 진행용), 해상도 설정(FHD)
